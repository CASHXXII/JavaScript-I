...
console.log(inventory[inventory.length - 1].car_make, inventory[inventory.length - 1].car_model, inventory[inventory.length - 1].car_year );
...
for (let i = 0; i < inventory.length; i++) {
  // create a new array of car models
